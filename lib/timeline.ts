...
const I_RV_D1: SoAItem[] = [
  ...
  { code: 'OSC',  label: 'Oscillometry',                            category: 'PR', seq: true,
    note: 'Perform BEFORE blood draw. No spirometry required at Day 1 Pre-Dose (fn. f).' },
  ...
  { code: 'MSH',  label: 'Medical & Smoking History — review/update', category: 'AD',
    note: 'Review and update any changes since last visit. Document as medical history until Day 1 dosing (fn. b).' },
  { code: 'COPH', label: 'COPD History & Medications — review/update', category: 'AD',
    note: 'Update COPD history and all current COPD medications before randomisation.' },
...
export const VISIT_D1: VisitDef = {
  ...
  phase: 'rv', items: I_RV_D1,
  coordinationNotes: [
    '🚨 ALL pre-dose assessments must complete BEFORE first drug administration.',
    'Review Medical & Smoking History (MSH) and COPD History & Medications (COPH) before eligibility check.',
    'Mandatory sequence: ECG → Blood draw (ECG first, fn. e).',
    'Oscillometry required (no spirometry at Day 1 Pre-Dose — spirometry resumes at Day 7, fn. f).',
...
export const VISIT_D3: VisitDef = {
  ...
  coordinationNotes: [
    ...
    'No oscillometry or spirometry required at Day 3 (per Table 1).',
...
export const VISIT_D28: VisitDef = {
  ...
  coordinationNotes: [
    ...
    'Sequence: Oscillometry → Spirometry (OSC must precede SPI, fn. f). No ECG required at Day 28.',
